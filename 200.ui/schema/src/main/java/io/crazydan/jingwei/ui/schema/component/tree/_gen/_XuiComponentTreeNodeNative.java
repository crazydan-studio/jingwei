...
import io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeNative;
...
public abstract class _XuiComponentTreeNodeNative extends io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeSlottable {
    ...
    public XuiComponentTreeNodeNative cloneInstance(){
        XuiComponentTreeNodeNative instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(XuiComponentTreeNodeNative instance){
    ...
    protected XuiComponentTreeNodeNative newInstance(){
        return (XuiComponentTreeNodeNative) ClassHelper.newInstance(getClass());
    }
}
