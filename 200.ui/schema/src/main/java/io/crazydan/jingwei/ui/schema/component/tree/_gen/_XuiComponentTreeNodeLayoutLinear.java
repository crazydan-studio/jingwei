...
import io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeLayoutLinear;
...
public abstract class _XuiComponentTreeNodeLayoutLinear extends io.nop.core.resource.component.AbstractComponentModel implements io.crazydan.duzhou.framework.ui.XuiLayout{
    ...
    public XuiComponentTreeNodeLayoutLinear cloneInstance(){
        XuiComponentTreeNodeLayoutLinear instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(XuiComponentTreeNodeLayoutLinear instance){
    ...
    protected XuiComponentTreeNodeLayoutLinear newInstance(){
        return (XuiComponentTreeNodeLayoutLinear) ClassHelper.newInstance(getClass());
    }
}
