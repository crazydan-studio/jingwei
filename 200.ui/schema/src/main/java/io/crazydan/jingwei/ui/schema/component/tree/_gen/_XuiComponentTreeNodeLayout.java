...
import io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeLayout;
...
public abstract class _XuiComponentTreeNodeLayout extends io.nop.core.resource.component.AbstractComponentModel implements io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeKeyed{
    ...
    public XuiComponentTreeNodeLayout cloneInstance(){
        XuiComponentTreeNodeLayout instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(XuiComponentTreeNodeLayout instance){
    ...
    protected XuiComponentTreeNodeLayout newInstance(){
        return (XuiComponentTreeNodeLayout) ClassHelper.newInstance(getClass());
    }
}
