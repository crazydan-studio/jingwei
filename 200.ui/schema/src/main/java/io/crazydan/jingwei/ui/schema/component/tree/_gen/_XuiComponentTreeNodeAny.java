...
import io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeAny;
...
public abstract class _XuiComponentTreeNodeAny extends io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeSlottable {
    ...
    public XuiComponentTreeNodeAny cloneInstance(){
        XuiComponentTreeNodeAny instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(XuiComponentTreeNodeAny instance){
        super.copyTo(instance);
        
        instance.setAttrs(this.getAttrs());
    }

    protected XuiComponentTreeNodeAny newInstance(){
        return (XuiComponentTreeNodeAny) ClassHelper.newInstance(getClass());
    }
}
