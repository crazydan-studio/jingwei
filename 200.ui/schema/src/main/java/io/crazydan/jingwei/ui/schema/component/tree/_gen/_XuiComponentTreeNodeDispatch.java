...
import io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeDispatch;
...
public abstract class _XuiComponentTreeNodeDispatch extends io.nop.core.resource.component.AbstractComponentModel implements io.crazydan.jingwei.ui.schema.component.tree.XuiComponentTreeNodeKeyed{
    ...
    public XuiComponentTreeNodeDispatch cloneInstance(){
        XuiComponentTreeNodeDispatch instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(XuiComponentTreeNodeDispatch instance){
    ...
    protected XuiComponentTreeNodeDispatch newInstance(){
        return (XuiComponentTreeNodeDispatch) ClassHelper.newInstance(getClass());
    }
}
