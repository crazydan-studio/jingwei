...
import io.crazydan.jingwei.ui.schema.app.XuiApp;
...
public abstract class _XuiApp extends io.nop.core.resource.component.AbstractComponentModel {
     ...
     * 
     */
    private io.crazydan.jingwei.ui.schema.app.XuiAppPages _pages ;
    ...
    public io.crazydan.jingwei.ui.schema.app.XuiAppPages getPages(){
      return _pages;
    }

    
    public void setPages(io.crazydan.jingwei.ui.schema.app.XuiAppPages value){
        checkAllowChange();
