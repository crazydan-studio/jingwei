...
public abstract class _XuiComponentTemplateNodeStatementChoose extends io.nop.core.resource.component.AbstractComponentModel implements io.crazydan.jingwei.ui.schema.component.template.XuiComponentTemplateNodeNamed{
     ...
     * >
     */
    private io.crazydan.jingwei.ui.schema.component.template.XuiComponentTemplateNodeStatementChooseOtherwise _otherwise ;
    ...
    public io.crazydan.jingwei.ui.schema.component.template.XuiComponentTemplateNodeStatementChooseOtherwise getOtherwise(){
      return _otherwise;
    }

    
    public void setOtherwise(io.crazydan.jingwei.ui.schema.component.template.XuiComponentTemplateNodeStatementChooseOtherwise value){
        checkAllowChange();
    ...
    public java.util.List<io.crazydan.jingwei.ui.schema.component.template.XuiComponentTemplateNodeStatementChooseWhen> getWhens(){
      return _whens;
    }
    ...
    public io.crazydan.jingwei.ui.schema.component.template.XuiComponentTemplateNodeStatementChooseWhen getWhen(String name){
    ...
    public void addWhen(io.crazydan.jingwei.ui.schema.component.template.XuiComponentTemplateNodeStatementChooseWhen item) {
        checkAllowChange();
