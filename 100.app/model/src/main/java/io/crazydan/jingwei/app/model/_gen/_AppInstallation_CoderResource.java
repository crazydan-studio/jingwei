...
public abstract class _AppInstallation_CoderResource extends io.nop.core.resource.component.AbstractComponentModel {
    ...
    public AppInstallation_CoderResource cloneInstance(){
        AppInstallation_CoderResource instance = newInstance();
        this.copyTo(instance);
        return instance;
    }

    protected void copyTo(AppInstallation_CoderResource instance){
    ...
    protected AppInstallation_CoderResource newInstance(){
        return (AppInstallation_CoderResource) ClassHelper.newInstance(getClass());
    }
}
